jQuery(function($) {
    ...
    function toggleNav() {
        document
            ...
            .classList.toggle('mobile-nav--is-open');
    }

    function toggleSearch() {
        document
            .querySelector('.search-form')
            .classList.toggle('search-form--is-open');
    }
    // handle search form show/hide
    document
        .querySelector('.search-form__close')
        .addEventListener('click', toggleSearch, false);
    document
        .querySelector('.nav__search')
        .addEventListener('click', toggleSearch, false);
    document
        .querySelector('.mobile-nav__search')
        .addEventListener('click', toggleSearch, false);
    document
        .querySelector('.search-form__close--nav')
        .addEventListener('click', toggleNav, false);
    ...
    function updateFab() {
        ...
        if (
            window.pageYOffset >
            document.querySelector('.header').offsetTop + 200
        ) {
